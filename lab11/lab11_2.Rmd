...
## Faceting: `facet_grid()`
As you can imagine, there are lots of options for faceting. Another useful facet type is `facet_grid`. Adjusting the labels on faceting [here](https://www.datanovia.com/en/blog/how-to-change-ggplot-facet-labels/).
```{r}
